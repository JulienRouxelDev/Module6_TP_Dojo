...
namespace Dojo.Controllers
{
    public class ArtMartialController : Controller
    {
        ...
        // GET: ArtMartial/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: ArtMartial/Create
